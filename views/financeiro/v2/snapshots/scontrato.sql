...
WITH ec_dedup AS (
         ...
         SELECT DISTINCT ON (shabmodelopgto."CODFILIAL", shabmodelopgto."CODCURSO", shabmodelopgto."IDHABILITACAOFILIAL", shabmodelopgto."CODGRADE", shabmodelopgto."CODTURNO", shabmodelopgto."IDPERLET") shabmodelopgto."CODFILIAL",
            ...
            shabmodelopgto."CODPLANOPGTO"
           FROM export_v2.shabmodelopgto
          ORDER BY shabmodelopgto."CODFILIAL", shabmodelopgto."CODCURSO", shabmodelopgto."IDHABILITACAOFILIAL", shabmodelopgto."CODGRADE", shabmodelopgto."CODTURNO", shabmodelopgto."IDPERLET", shabmodelopgto."CODPLANOPGTO"
        )
